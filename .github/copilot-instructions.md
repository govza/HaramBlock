...
This project is a browser extension designed to enhance user experience by blocking unwanted content
and providing AI-driven media processing capabilities. The extension processes images and videos on
web pages, applying AI predictions to filter or style content based on user preferences.

## Folder Structure

- **entrypoints/content/**: Contains the main content scripts that interact with web pages.
- **entrypoints/background/**: Contains background scripts that manage the extension's lifecycle and
  state.
...
- TypeScript: The primary language for developing the extension, providing type safety and modern
  JavaScript features.
