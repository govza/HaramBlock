    ...
    <div className='space-y-6'>
      ...
      <div className='space-y-4'>
        <div className='bg-secondary p-4 rounded-lg transition-all duration-200 hover:bg-surface hover:shadow-lg'>
          <h3 className='text-lg font-semibold text-text-primary mb-1'>{t('About.extensionInformation')}</h3>
          <div className='space-y-2'>
            <div className='flex gap-4'>
              <span className='text-text-body text-base'>{t('About.version')}</span>
        ...
        <div className='bg-secondary p-4 rounded-lg transition-all duration-200 hover:bg-surface hover:shadow-lg'>
          <h3 className='text-lg font-semibold text-text-primary mb-2'>{t('About.description')}</h3>
          <p className='text-text-body text-base leading-relaxed'>{aboutData.description}</p>
        </div>

        <div className='bg-secondary p-4 rounded-lg transition-all duration-200 hover:bg-surface hover:shadow-lg'>
          <h3 className='text-lg font-semibold text-text-primary mb-2'>{t('About.supportLinks')}</h3>
          <div className='space-y-2'>
            <a
